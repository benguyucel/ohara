window.addEventListener('load', function() {
    ...
    dropdownButton.addEventListener('click', function() {
        if (dropdownMenu.classList.contains('hide')) dropdownMenu.classList.remove('hide');
        else {
    ...
    menuButton.addEventListener('click', function() {
        if (leftSide.style.marginLeft == "0px") leftSide.style.marginLeft = "-280px";
        else {
            leftSide.style.marginLeft = "0px";
            if (rightSide.style.marginRight != "-420px") rightSide.style.marginRight = "-420px";
        }
    });
    profileButton.addEventListener('click', function() {
        if (rightSide.style.marginRight == "0px") rightSide.style.marginRight = "-420px";
        else {
            rightSide.style.marginRight = "0px";
            if (leftSide.style.marginLeft != "-280px") leftSide.style.marginLeft = "-280px";
        }
    });
    mediaFunction = ()=>{
    ...
    if (window.outerWidth < 1200) mediaFunction();
